...
|---|---|---|
| Koweerawong & Kaemarungsi, 2013 | `raw/Indoor localization improvement via adaptive RSS fingerprinting database - The Internationa.pdf` | ⚠️ SCANNED — adaptive database maintenance to handle RSS drift |
