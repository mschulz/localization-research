...
week-covered: 2026-07-25 to 2026-07-31
new-files-in-raw: 0
...
**No new files were added to `raw/` this week.** The July 25–31 window was checked three ways — by modification time (`find -newermt 2026-07-24`), by creation/change time, and via git history (`git log --since=2026-07-25 -- raw/`) — and none show any activity. The most recent source in the vault remains dated 2026-06-15 (the mid-June import). No compilation was triggered; the knowledge base is unchanged since the last run.
...
Checked `outputs/` for weekly intelligence reports older than one month (cutoff 2026-06-30). None found — the oldest weekly summaries present are dated 2026-07-04, still within the retention window. No reports removed this cycle.
